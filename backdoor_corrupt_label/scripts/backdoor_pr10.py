...
if __name__ == "__main__":
    ...
    train_list = "/home/gkempego/CSE598/dataset/train_pr10.csv"
    ...
    path_to_save_model = "/home/gkempego/CSE598/models/pr10/run1"
    ...
    # saved_model = "/home/gkempego/CSE598/models/pr10/resnet50.pth"
    # saved_model = "/Users/gpks/Documents/ASU/06Fall2022/CSE598/Project/Semantic_Backdoor_Attack/models/pr10/resnet50.pth"
    ...
    print(f"Model with poison ratio 10% on clean test data - AUC: {AUC_value}")
    ...
    print(f"Model with poison ratio 10% on poisoned test data - AUC: {AUC_value_pd}")
