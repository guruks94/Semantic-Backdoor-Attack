...
if __name__ == "__main__":
    ...
    train_list = "/home/gkempego/CSE598/dataset/train_pr25.csv"
    ...
    path_to_save_model = "/home/gkempego/CSE598/models/pr25/run1"
    ...
    # saved_model = "/home/gkempego/CSE598/models/pr25/resnet50.pth"
    # saved_model = "/Users/gpks/Documents/ASU/06Fall2022/CSE598/Project/Semantic_Backdoor_Attack/models/pr25/resnet50.pth"
    ...
    print(f"Model with poison ratio 25% on clean test data - AUC: {AUC_value}")
    ...
    print(f"Model with poison ratio 25% on poisoned test data - AUC: {AUC_value_pd}")
